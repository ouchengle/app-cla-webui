...
export const getAuthEmail = '/v1/email/authcodeurl/gmail/init_auth';                //邮箱授权             方式patch
export const getReAuthEmail = '/v1/email/authcodeurl/gmail/reauth';                 //邮箱重新授权          方式patch
