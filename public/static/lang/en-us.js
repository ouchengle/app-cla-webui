module.exports = {
    ...
    tips: {
        ...
        many_employee_managers: 'The manager has reached the upper limit and cannot continue to create',
    ...
    org: {
        ...
        email_authorize: 'Email authorize',
        toDetail: 'Detail',
        ...
        config_cla_email_authorize_desc1: 'Send the super administrator account for the enterprise through the email',
        config_cla_email_authorize_desc2: 'Send the e-mail containing the signed document to the enterprise through this email',
        config_cla_email_authorize_desc3: 'Send the email of employee signing status change to the enterprise manager through the email',
        ...
        email_reauthorize_title: 'The email bound to the organization is {email}. If the current system cannot send mail normally, please reauthorize the email',
        select_email_type: 'Please select email type to reauthorize',
        email_reauthorize_confirm: 'Update the authorization information of all communities bound with this email',
    },
};
