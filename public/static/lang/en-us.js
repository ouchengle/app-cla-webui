module.exports = {
    ...
    tips: {
        ...
        noSession: 'System error, please refresh the email suffix list and try again',
        sameEmailSuffix: 'Email suffix already exists, please do not add it repeatedly',
    ...
    corp: {
        ...
        addSubEmail: 'Add Email Suffix',
        subEmailDesc: 'In the input box below, enter a email containing the suffix you need to add. After verification, it can be added successfully, and the employee can use the email with the same suffix as the sub email for employee signature',
